...
Item {
  ...
  // Address of the window focused when the picker opened, so the emoji is
  // inserted back into it rather than whatever follow_mouse focuses once the
  // picker closes (mouse selection path).
